...
private:
    ...
    **********************************************************************************/
                    ...
                    Omega_h::MeshSets& aMeshSets)
    {
        ...
        std::shared_ptr<Plato::Elliptic::MassMoment<GradientU>> tGradientU = 
             std::make_shared<Plato::Elliptic::MassMoment<GradientU>>(aMesh, aMeshSets, mDataMap);
        tGradientU->setMaterialDensity(mMaterialDensity);
        tGradientU->setCalculationType(tCalculationType);
        tMassFunction->setEvaluator(tGradientU);
    ...
    **********************************************************************************/
                           ...
                           const std::string & aMomentType)
    {
        ...
        tNumerator->setEvaluator(tNumeratorGradientU);
    ...
    **********************************************************************************/
                        ...
                        const std::string & aMomentType)
    {
        ...
        tSecondMomentFunction->setEvaluator(tGradientU);
