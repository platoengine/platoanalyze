...
class HyperbolicAbstractLinearStress :
...
public:
    ...
    **********************************************************************************/
    HyperbolicAbstractLinearStress(const Omega_h::Matrix<mNumVoigtTerms,
    ...
    **********************************************************************************/
    HyperbolicAbstractLinearStress(const Teuchos::RCP<Plato::LinearElasticMaterial<mSpaceDim>> aMaterialModel) :
...
PLATO_HYPERBOLIC_EXPL_DEC2(Plato::Hyperbolic::HyperbolicAbstractLinearStress  , Plato::SimplexMechanics, 1)
#endif

#ifdef PLATOANALYZE_2D
PLATO_HYPERBOLIC_EXPL_DEC2(Plato::Hyperbolic::HyperbolicAbstractLinearStress  , Plato::SimplexMechanics, 2)
#endif

#ifdef PLATOANALYZE_3D
PLATO_HYPERBOLIC_EXPL_DEC2(Plato::Hyperbolic::HyperbolicAbstractLinearStress  , Plato::SimplexMechanics, 3)
#endif
