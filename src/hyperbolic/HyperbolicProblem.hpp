      ...
      public:
        ...
        HyperbolicProblem(
          ...
          Comm::Machine aMachine
            ...
            mPDEConstraint     (aMesh, aMeshSets, mDataMap, aProblemParams,
                                aProblemParams.get<std::string>("PDE Constraint")),
            mNewmarkIntegrator (aProblemParams.sublist("Time Integration")),
